...
// "s"表示set类型
// "v"表示vector数据类型
// 'l'表示list数据类型                     list 是c++容器 ,详解见https://blog.csdn.net/zhouzhenhe2008/article/details/77428743/  lishuwei 2018.11.24
// "KF"表示KeyPoint数据类型

namespace ORB_SLAM2
{
//track初始化   lishuwei 2018.11.24
    ...
    mpFrameDrawer(pFrameDrawer), mpMapDrawer(pMapDrawer), mpMap(pMap), mnLastRelocFrameId(0)
{
    ...
    if(sensor==System::RGBD)               // ？？？ lishuwei 2017.11.24
    {
